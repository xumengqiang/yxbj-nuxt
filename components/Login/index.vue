        ...
        <div class="auth-form">
            <el-form ref="loginForm" :model="loginForm" :rules="rules">
                <div class="panfish">
                    <img
                        v-if="isGifType === 1"
                        src="https://file.youxiubiji.com/nuxt/open.png"
                    />
                    <img
                    ...
                    <img
                        v-else
                        src="https://file.youxiubiji.com/nuxt/def.png"
                    />
                </div>
                <div class="auth-nav">
                    <div class="title">
                ...
                <div v-if="isFailure || isLoadingScan" class="image-slot">
                    <span v-if="isFailure" class="fail"
                        >二维码已失效，请刷新</span
                    >
                    <span v-if="isLoadingScan" class="success"
                        >请在微信中点击确认登录</span
                    >
                </div>
        ...
        initWebSocket() {
            ...
            const messageHandler = {
                ...
                CODE_ID: async res => {
                    ...
                    this.wxCodeSrc =
                        "https://api.youxiubiji.com/" + $res.data.url;
