    ...
    <div class="app-container">
        ...
        <el-table :data="list" border stripe style="width: 100%">
            <el-table-column
                ...
                width="50"
            />
            <el-table-column prop="cateName" label="标题" align="center">
            </el-table-column>
...
export default {
    ...
    methods: {
        ...
        SwitchState(state, id) {
            ...
            cateDisable({ id, state: state ? 0 : 1 })
                .then(() => {
                    this.$message({
                        message: "更新成功",
                        type: "success",
        ...
        CreateSwiper() {
            ...
            this.isEdit = false;
            this.postForm.id = "";
            this.postForm.cateName = "";
            this.postForm.sort = 0;
        },
        /**
         * 编辑分类
         */
        handleEdit(id, cateName, sort) {
            this.dialogVisible = true;
            this.isEdit = true;
            this.postForm.id = id;
            this.postForm.cateName = cateName;
